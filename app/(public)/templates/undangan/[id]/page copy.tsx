...
import {
  ArrowLeft, Heart, Star, Clock, Check, Share2, Eye,
  Calendar, MapPin, Users, Music, Gift, Camera, Sparkles,
  Shield, Download, MessageCircle, Mail, Phone, Loader2,
  Copy, CheckCircle, ChevronRight, Award, TrendingUp,
  FileText, Settings, Palette, Layout, Smartphone, Globe,
  Zap, Volume2, Video, Edit, ShoppingBag
} from "lucide-react";
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <div className="mt-6 flex gap-3 justify-center">
            ...
            <Button onClick={() => router.push("/templates/undangan")} className="bg-rose-500 hover:bg-rose-600">
              Lihat Template Lain
            </Button>
          </div>
        </div>
            ...
            {images.length > 1 && (
              <div className="flex gap-2 overflow-x-auto pb-2">
                {images.map((img, idx) => (
                  ...
                  >
                    <img src={img} alt={`${template.name} - ${idx + 1}`} className="h-full w-full object-cover" />
                  </button>
                ))}
              </div>
            )}
            ...
            <Tabs defaultValue="description" className="w-full">
              ...
              <TabsContent value="description" className="mt-4 space-y-4">
                <div className="prose prose-sm dark:prose-invert max-w-none">
                  <p>{template.description || "Template undangan digital yang elegan dan modern untuk momen spesial Anda."}</p>
                </div>
              ...
              <TabsContent value="details" className="mt-4 space-y-4">
                <div className="grid gap-3">
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-medium">{template.category || template.type_template || "-"}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Akses langsung setelah pembayaran</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
