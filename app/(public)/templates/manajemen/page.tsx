...
const managementTemplates = [
  ...
  },
  {
    ...
    duration: "5 hari",
    demoUrl: "/demo/document-management",
  },
  {
    id: 10,
    name: "POS System",
...
const categories = [
  { id: "all", label: "Semua", count: 10 },
  { id: "inventory", label: "Inventory", count: 1 },
  { id: "hrd", label: "HRD", count: 1 },
  { id: "project", label: "Project", count: 1 },
  { id: "finance", label: "Keuangan", count: 1 },
  { id: "crm", label: "CRM", count: 1 },
  { id: "warehouse", label: "Warehouse", count: 1 },
  { id: "helpdesk", label: "Helpdesk", count: 1 },
  { id: "document", label: "Document", count: 1 },
  { id: "pos", label: "POS", count: 1 },
];
...
export default function ManajemenPage() {
  ...
  const filteredTemplates = managementTemplates.filter((template) => {
    ...
    if (range && (template.price < range.min || template.price > range.max))
      return false;
    return true;
  });
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="border-b border-border bg-gradient-to-br from-purple-500/5 via-background to-pink-500/5 px-4 py-8 sm:py-12 md:py-16">
        <div className="mx-auto max-w-7xl text-center">
          <Badge className="mb-3 bg-purple-500/10 text-purple-600 dark:text-purple-400">
          ...
          <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground sm:text-base">
            Kelola bisnis Anda lebih efisien dengan sistem manajemen
            terintegrasi.
          </p>
          ...
          <div className="mx-auto mt-6 max-w-xl sm:mt-8">
            <div className="relative">
              ...
              <Input
                placeholder="Cari sistem manajemen..."
                value={searchQuery}
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {activeFiltersCount > 0 && (
                  <Badge className="absolute -right-1.5 -top-1.5 h-4 w-4 rounded-full bg-purple-500 p-0 text-[10px]">
                    {activeFiltersCount}
                  </Badge>
                )}
              </Button>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {priceRanges.map((range) => (
                        <Button
                          ...
                          className={cn(
                            "h-7 text-xs",
                            selectedPriceRange === range.id && "bg-purple-500",
                          )}
                        >
                          {range.label}
                        </Button>
              ...
              {sortedTemplates.map((template, idx) => (
                ...
                >
                  <Card className="group h-full overflow-hidden transition-all hover:shadow-lg">
                    <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-950/30 dark:to-pink-950/30">
                      <div className="absolute inset-0 flex items-center justify-center">
                        <Database className="h-10 w-10 text-purple-400/50" />
                      </div>
                    ...
                    <CardFooter className="flex gap-2 p-3 pt-0">
                      ...
                      >
                        <Link href={`/templates/manajemen/${template.id}`}>
                          Detail
                        </Link>
                      </Button>
                      <Button
                        asChild
                        size="sm"
                        className="h-8 flex-1 bg-purple-500 text-xs hover:bg-purple-600"
                      >
